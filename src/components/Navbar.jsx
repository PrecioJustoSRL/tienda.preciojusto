...
export default function BottomNavigation({ rol }) {
    ...
    const Profile = () => {
        return <li className="px-5">
            <Link href={`/${rol}/Perfil`} onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white   hover:bg-[#00000030] dark:hover:bg-gray-700">
    ...
    const Store = () => {
        return <li className="px-5">
            <Link href="/Cliente" onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white   hover:bg-[#00000030] dark:hover:bg-gray-700">
                <img src="/tienda.svg" className="h-[17px]" alt="" />
    ...
    const Order = () => {
        return <li className="px-5">
            <Link href={`/${rol}/Pedidos`} onClick={() => setNav(false)} class="flex items-center p-2 rounded-lg dark:text-white   hover:bg-[#00000030] dark:hover:bg-gray-700">
        ...
        return <li className="px-5" onClick={signOutHandler}>
            <button onClick={() => setNav(false)} class="w-full flex items-center p-2 rounded-lg dark:text-white   hover:bg-[#00000030] dark:hover:bg-gray-700">
                <svg width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M10.75 7V3.25C10.75 2.91848 10.8817 2.60054 11.1161 2.36612C11.3505 2.1317 11.6685 2 12 2H23.25C23.5815 2 23.8995 2.1317 24.1339 2.36612C24.3683 2.60054 24.5 2.91848 24.5 3.25V20.75C24.5 21.0815 24.3683 21.3995 24.1339 21.6339C23.8995 21.8683 23.5815 22 23.25 22H12C11.6685 22 11.3505 21.8683 11.1161 21.6339C10.8817 21.3995 10.75 21.0815 10.75 20.75V17" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
...
//             </li>
//             <li className="px-5" onClick={signOutHandler}>
//                 <button onClick={() => setNav(false)} class="relative w-full flex items-center p-2 rounded-lg dark:text-white   hover:bg-[#00000030] dark:hover:bg-gray-700">
//                     <svg width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
//                         <path d="M5.75 15.75L2 12L5.75 8.25" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
//                         <path d="M2 12H19.5" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
//                         <path d="M10.75 7V3.25C10.75 2.91848 10.8817 2.60054 11.1161 2.36612C11.3505 2.1317 11.6685 2 12 2H23.25C23.5815 2 23.8995 2.1317 24.1339 2.36612C24.3683 2.60054 24.5 2.91848 24.5 3.25V20.75C24.5 21.0815 24.3683 21.3995 24.1339 21.6339C23.8995 21.8683 23.5815 22 23.25 22H12C11.6685 22 11.3505 21.8683 11.1161 21.6339C10.8817 21.3995 10.75 21.0815 10.75 20.75V17" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
