...
export default function Button({ theme, styled, click, children }) {
    ...
    switch (theme) {
        case 'Loading':
            return <button
                type="submit"
                className="text-white bg-gray-500 border border-gray-100 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-[16px] w-full px-2 py-3 text-center space-x-2 z-20"
