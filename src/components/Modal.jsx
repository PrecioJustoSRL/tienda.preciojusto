            ...
            <div className="relative w-full max-w-md max-h-full">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="p-6 text-center">
                        ...
                        {!alert && <>
                            <button type="button" className="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-[14px] font-medium px-5 py-4 hover:text-gray-900 focus:z-10 mr-2" onClick={cancelHandler}>
                            {cancelText ? cancelText : 'Cancelar'}
                            </button>
                            {funcion && <button type="button" className={`focus:ring-4 focus:outline-none focus:ring-gray-300 dark:focus:ring-gray-300 font-bold rounded-lg text-[14px] inline-flex items-center px-5 py-4 text-center ${primary ? primary : 'bg-red-600 hover:bg-red-800 text-white '}`} onClick={funcion}>
