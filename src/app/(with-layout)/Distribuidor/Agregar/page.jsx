    ...
    function save(e) {
        ...
        Object.entries(categorias).map(async (i) => {
            if (i[1] == true) {
                ...
                setDisable(true)
                await writeUserData('Producto', { ...state, categoria: i[0], uuid: uid, distribuidor: user.uuid }, user.uuid, userDB, setUserData, setUserSuccess, 'Se ha guardado correctamente', 'Perfil')
